...
public class echoAR : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        try
        {
            StartCoroutine(QueryDatabase(serverURL,modelToGet));
    ...
    public void GetOzone()
    {
        ...
        try
        {
            StartCoroutine(QueryDatabase(serverURL,"Ozonevideo"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
    ...
    public void GetCO2()
    {
        ...
        try
        {
            StartCoroutine(QueryDatabase(serverURL,"CO2video"));
        }
        catch (System.Exception e)
        {
            Debug.Log(e);
